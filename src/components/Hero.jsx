...
const Hero = () => {
  ...
  return (
    <div className="h-[auto] w-[96%] flex flex-col justify-center items-center gap-[20px]">
      ...
      <h2 className="font-[500] text-[2rem] min-[500px]:text-[3rem] min-[768px]:text-[4rem] text-stroke-black  text-center bg-gradient-to-r from-sky-700 to-lime-200 bg-clip-text text-transparent">
        Discover Your Next Favorite Movie
      </h2>
      <h2 className="font-[500] min-[500px]:text-[1.25rem] min-[768px]:text-[1.50rem] text-center">
      ...
      <button
        onClick={goToMovies}
        className="
        mt-[50px] bg-gradient-to-r from-sky-900 to-sky-700 font-[600] min-[500px]:text-[1.25rem] text-white rounded-[30px]
